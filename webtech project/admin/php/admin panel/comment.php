...
<script>
        function loadComment()
        {
            ...
            xhttp.open("GET", "ajaxMethods.php?commentUsername="+key, true);
            xhttp.send();
        }
        function deleteComment(id)
        {
            ...
            xhttp.open("GET", "ajaxMethods.php?commentId="+id, true);
            xhttp.send();
        }
    </script>
    ...
    <div class="table_wrapper">
                ...
                <div class="search form-input">
                    ...
                    <input type="search" name="search" id="search" onkeyup="loadComment()" autocomplete="off">
                </div>
